...
function testarFormulario(evento,frm){
  ...
  if (nome=="") document.querySelector("#erroNome").classList.add("show");
  ...
  if (frm["endereco"].value=="") 
    msgErros.innerHTML += "<li>Campo Rua Deve ser preenchido!</li>"
  ...
  if (frm["email"].value=="") 
    msgErros.innerHTML += "<li>Campo Email Deve ser preenchido!</li>"

  if (frm["sexo"].value=="") 
    msgErros.innerHTML += "<li>Campo Sexo Deve ser preenchido!</li>"

  if (frm["nro"].value=="") 
    msgErros.innerHTML += "<li>Campo Nº Deve ser preenchido!</li>"
